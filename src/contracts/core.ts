...
export type OptionTuple<K = any> = [BonbonsToken<K>, Partial<K>];
export type InjectableServiceType = Constructor<any> | [InjectableToken<any>, ImplementDIValue<any>] | BonbonsInjectEntry<any>;
